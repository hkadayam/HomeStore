...
pub type ResultReceiver<'a> = crate::result_channel::ResultReceiver<'a, tokio::sync::mpsc::UnboundedSender<ChannelMessage>, tokio::sync::mpsc::UnboundedReceiver<ChannelMessage>>;
...
impl Reactor {
            ...
            .spawn(move || {
                ...
                rt.block_on(async {
                    local.run_until(async move {
                        ...
                        // Spawn receiver loop - runs in separate task
                        let channel_for_spawn = Arc::clone(&channel_for_thread);
                        tokio::task::spawn_local(async move {
                            channel_for_spawn.run_receiver_loop().await;
                        });
                        
                        // Run work_loop in background - handles both remote and local tasks
    ...
    pub async fn shutdown(&self) {
        ...
        unsafe {
            ...
            let shutdown_tx = (*self.shutdown_tx.get()).take();
