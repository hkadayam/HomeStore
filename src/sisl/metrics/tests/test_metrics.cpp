...
nlohmann::json expected = {
    {"Cache", {
        {"cache1", {
            ...
            {"Histograms percentiles avg/p50/p95/p99", {
                {"Cache Delete Latency", "200.0 / 200.0 / 200.0 / 200.0" },
                {"Cache Read Latency", "150.0 / 150.0 / 150.0 / 150.0" },
                {"Cache Write Latency", "125.0 / 125.0 / 150.0 / 150.0"}
            }}
        }},
        {"cache1_2", {
            {"Counters", {}},
            ...
            {"Histograms percentiles avg/p50/p95/p99", {
                {"Cache Delete Latency", "275.0 / 275.0 / 400.0 / 400.0" },
                {"Cache Read Latency", "350.0 / 350.0 / 350.0 / 350.0" },
                {"Cache Write Latency", "200.0 / 200.0 / 200.0 / 200.0"}
            }}
        }},
    }},
    {"Tree", {
    ...
    {"Global", {
        {"Instance1", {
            ...
            {"Histograms percentiles avg/p50/p95/p99", {
                {"Distribution of request per transactions", "18.2 / 8.0 / 48.0 / 48.0"}
            }}
        }}
    }}
};
