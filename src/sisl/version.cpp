...
void VersionMgr::createAndInit() {
    ...
    // PACKAGE_VERSION is a globally-defined, already-quoted string flag (see top-level CMakeLists), so it is used
    // directly here rather than stringized as the standalone sisl package once did.
